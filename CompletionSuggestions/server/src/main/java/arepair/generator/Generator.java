...
import static arepair.generator.util.Util.*;
...
public class Generator {
    ...
    public Generator(GeneratorOpt opt, AlloyEvaluation alloyEvaluation) {
        this.inheritanceHierarchy = CompatUtils.buildInheritanceHierarchy(alloyEvaluation.getWorld());
        this.opt = opt;
