...
// Completion: Resolve later
fact Node_1 {
	all o : Object, c : Commit | o -> c in belongsTo implies committedAs[this, o, c]
}

// Completion: Resolve later
fact Node_2 {
	(some o : Object, c : Commit | committedAs[this, o, c]) implies some belongsTo
}
...
// Completion: Resolve later
pred BlobFacts_3 {
	all b1, b2, b' : Blob | b1 -> b2 -> b' in merging implies b2 -> b1 -> b' in merging
}
...
pred add_test_1_1 { some s, sp: State, f: File | f.parent = Root }
pred add_test_1_2 { some s, sp: State, f: File | f in current.s }
...
check rm_rec_correct {
	all s,sp : State, n : Node | invariant[s] and rm_rec[s,sp,n] implies invariant[sp]
} for 3 but 2 State
