/**
 * kafka_final.als
 * Merged single-file model derived from kafka_main.als and all its transitive dependencies.
 * Merge order: signatures → functions → invariants → actions → kafka_main
 */
