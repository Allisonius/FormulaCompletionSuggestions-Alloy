...
public class CrossProduct {
	...
	int highest_ranked_template = 18;
	...
	public int priorityLevel(String incompleteTerm, String template) {
		...
		if(incompleteTerm.equals("VARIABLE")) {
			...
			else if(template.equals("VARIABLE->VARIABLE->VARIABLE")) {
				return 6;
			}
			...
			else if(template.equals("VARIABLE.^RELATION")) { //new
				return 9;
			}
		}
			...
			else if(template.equals("SIGNATURE.RELATION")) { //new
				return 4;
			}
			else if(template.equals("SIGNATURE + SIGNATURE")) {
				return 5;
		...
		else if(incompleteTerm.equals("SIGNATURE.RELATION")) { //new
			if(template.equals("VARIABLE.RELATION")) {
				return 1;
			}
		}
