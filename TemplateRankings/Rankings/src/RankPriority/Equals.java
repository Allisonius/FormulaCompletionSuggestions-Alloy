...
public class Equals {
	...
	public int priorityLevel(String incompleteTerm, String template) {
		...
		if(incompleteTerm.equals("VARIABLE")) {
			...
			else if(template.equals("VARIABLE.RELATION+VARIABLE->VARIABLE")) {
				return 6;
			}
		}
			...
			if(template.equals("VARIABLE.RELATION.VARIABLE")) {
				return 1;
			}
			else if(template.equals("SIGNATURE")) {
				return 2;
		...
		else if(incompleteTerm.equals("VARIABLE.RELATION.RELATION")) {//new
			if(template.equals("SIGNATURE")) {
				return 1;
			}
			else if(template.equals("VARIABLE.RELATION.VARIABLE")) {
