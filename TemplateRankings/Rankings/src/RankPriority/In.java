...
public class In {
	...
	public int priorityLevel(String incompleteTerm, String template) {
		...
		if(incompleteTerm.equals("VARIABLE")) {
			...
			else if(template.equals("SIGNATURE.VARIABLE.RELATION")) {
				return 9;
			}
			else if(template.equals("VARIABLE.^VARIABLE")) {
				return 9;
		...
		else if(incompleteTerm.equals("RELATION.SIGNATURE")) {
			if(template.equals("SIGNATURE")) {
				return 1;
			}
			else if(template.equals("RELATION.SIGNATURE")) {
		...
		else if(incompleteTerm.equals("RELATION.RELATION")) {
			if(template.equals("RELATION")) {
				return 1;
			}
		}
			...
			else if(template.equals("RELATION.VARIABLE->SIGNATURE")) {
				return 2;
			}
		}
