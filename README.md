...
- **CompletionSuggestions:** Includes the code, data and instructions to install the Alloy Language Server, which is a Visual Studio Code extension that performs our formula completion suggestions. Within this folder, there are instructions on how to generate the suggestions using (1) our completion suggestions, (2) the AGen "generator" baseline and (3) LLM models are provided by the github copilot. The latter of which is used for a small investigation over a subset of the models.
