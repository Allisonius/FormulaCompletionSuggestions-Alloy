...
public class BinaryFormula extends BinaryExprOrFormula {
  ...
  private BinaryOp findOp(ExprBinary expr) {
    switch (expr.op) {
      ...
      case IFF:
        return BinaryOp.IFF;
      /*case UNTIL:
    	  return BinaryOp.UNTIL;
      case RELEASES:
    	  return BinaryOp.RELEASES;
      case SINCE:
    	  return BinaryOp.SINCE;
      case TRIGGERED:
    	  return BinaryOp.TRIGGERED;*/
      //case TRCSEQ:
    	//  return BinaryOp.
      default:
  ...
  public enum BinaryOp {
    ...
    UNTIL("until", Group.TEMPORAL_OPERATOR),
    RELEASES("releases", Group.TEMPORAL_OPERATOR),
    SINCE("since", Group.TEMPORAL_OPERATOR),
    TRIGGERED("triggered", Group.TEMPORAL_OPERATOR);
   // TRCSEQ(";", Group.TRCSEQ);
